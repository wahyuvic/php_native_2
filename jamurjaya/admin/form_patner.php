          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Form Admins </h6>
              </div>
            </div>
				    ...
				    <table width="616" border="0">
                      <tr>
					   ...
					   <tr>
                        ...
                        <td width="445"><label>
                          <table width="452" border="0">
                            <tr>
                              <td width="188"><input name="posisi" type="text" class="form-control" id="posisi"/></td>
                              <td></td>
                      ...
                      <tr>
                        <td colspan="3">Twitter
                          <input name="twitter" type="text" id="twitter" value="-" size="100" />
                          <div id="pemberitahuan3"></div></label></td>
                      </tr>
					  
					  <tr>
                        <td colspan="3">Instagam
                          <input name="IG" type="text" id="IG" value="-" size="100" />
                          <div id="pemberitahuan5"></div></label></td>
                      </tr>
					  
					  <tr>
                        <td colspan="3">Facebook
                          <input name="FB" type="text" id="FB" value="-" size="100" />
