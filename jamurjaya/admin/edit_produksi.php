...
<?php
	include "../koneksi.php";
	$id=$_GET['id'];
	$query="SELECT * FROM profil_produksi where id_profil='$id'";
          ...
          <div class="card my-4">
            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
              <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <h6 class="text-white text-capitalize ps-3">Edit Data Profil Produksi</h6>
              </div>
            </div>
				  ...
				  <form action="olahdata/produksi.php" name="form1" method="post" enctype="multipart/form-data">
				   <input name="id" type="hidden" class="form-control" id="id" value="<?php echo"$hasil_lopping[0]";?>"/>
				    ...
				    <table width="616" border="0">
                      ...
                      <tr>
                        <td colspan="3">Link
                          <input name="KT" type="text" id="KT" value="<?php echo"$hasil_lopping[3]";?>" size="100" />
